...
class DCAApplicationSrcFile(SourceFile):
    ...
    def instantiate_file(self):
        ...
        self.df = self.df.rename(columns={"Application ID": "Record ID 2", "License Number": "Record ID", "Expiration Date": "License Expiration Date", "License Category": "Industry", "Start Date": "APP Start Date", "End Date": "APP End Date", "Status": "APP Status", "Status Date": "APP Status Date", "License Start": "License Start Date"})
